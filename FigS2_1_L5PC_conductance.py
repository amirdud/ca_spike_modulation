...
gHVA_ca_np = np.array(gHVA)
gLVA_ca_np = np.array(gLVA)
gSK_k_np = np.array(gSK_E2)
gSKv3_k_np = np.array(gSKv3_1)
gIm_k_np = np.array(gIm)
gIh_cn_np = np.array(gIh)
gNaTs2_t_na_np = np.array(gNaTs2_t)
...
conductance_list = np.array([gHVA_ca_np, gLVA_ca_np, gSK_k_np, gSKv3_k_np,
                             gIm_k_np, gIh_cn_np, gNaTs2_t_na_np])
...
ax0.set_xlim([-10, 70])
plt.show()
# fig.savefig("./FigS2/figS2_L5PC_conductances.svg", format='svg')

fig,ax1 = plt.subplots(figsize=(3, 2))
ax1.plot(t_np_shifted, dend_v_np, 'k', label='dend_v')
...
ax1.set_xlim([-10, 70])
plt.show()
# fig.savefig("./FigS2/figS2_L5PC_voltages.svg", format='svg')

fig, ax2 = plt.subplots(figsize=(3, 0.5))
ax2.plot(t_np_shifted, syn_1_i * (-1), 'k', label='I')
...
plt.show()
# fig.savefig("./FigS2/figS2_L5PC_input.svg", format='svg')